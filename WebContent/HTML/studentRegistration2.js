...
function validateFullName() {
	...
	if (fullName == "" || fullName == null) {
		document.getElementById("errFullName").innerHTML = "Stdent name cannot be blank";
		return false;
	} else if (!pattern1.test(fullName)) {
		document.getElementById("errFullName").innerHTML = "Enter name in the format less than 20 characters";
		return false;
	} else {
		return true;
	}
